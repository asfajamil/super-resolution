...
class DRLN(nn.Module):
    def __init__(self, args):
        ...
        self.c5 = ops.BasicBlock(chs*6, chs, 3, 1, 1)
        self.c6 = ops.BasicBlock(chs*7, chs, 3, 1, 1)
        self.c7 = ops.BasicBlock(chs*2, chs, 3, 1, 1)
        self.c8 = ops.BasicBlock(chs*3, chs, 3, 1, 1)
        self.c9 = ops.BasicBlock(chs*4, chs, 3, 1, 1)
        self.c10 = ops.BasicBlock(chs*5, chs, 3, 1, 1)
        self.c11 = ops.BasicBlock(chs*6, chs, 3, 1, 1)
        self.c12 = ops.BasicBlock(chs*7, chs, 3, 1, 1)
