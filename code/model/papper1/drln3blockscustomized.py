...
class DRLN(nn.Module):
    def __init__(self, args):
        ...
        self.c4 = ops.BasicBlock(chs*5, chs, 3, 1, 1)
        self.c5 = ops.BasicBlock(chs*2, chs, 3, 1, 1)
        self.c6 = ops.BasicBlock(chs*3, chs, 3, 1, 1)
        self.c7 = ops.BasicBlock(chs*4, chs, 3, 1, 1)
        self.c8 = ops.BasicBlock(chs*5, chs, 3, 1, 1)
        self.c9 = ops.BasicBlock(chs*2, chs, 3, 1, 1)
        self.c10 = ops.BasicBlock(chs*3, chs, 3, 1, 1)
        self.c11 = ops.BasicBlock(chs*4, chs, 3, 1, 1)
        self.c12 = ops.BasicBlock(chs*5, chs, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        b9 = self.b9(a2)
        c9 = torch.cat([o8, b9], dim=1)
        o9 = self.c9(c9)
        

        b10 = self.b10(o9)
        c10 = torch.cat([c9, b10], dim=1)
        o10 = self.c10(c10)
